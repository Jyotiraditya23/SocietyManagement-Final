...
Tracks monthly maintenance logs for each flat.
...
const MaintenanceSchema = new mongoose.Schema({
  ...
  late_fee: {
    type: Number,
    default: 0  // Applied if unpaid after threshold
  },
  total_amount: {
    type: Number,
    default: 1000
...
// Ensure a flat only has one entry per month/year
...
Transaction logs for maintenance bill payments.
